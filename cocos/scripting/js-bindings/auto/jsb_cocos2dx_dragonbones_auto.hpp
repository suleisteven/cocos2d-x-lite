...
bool js_cocos2dx_dragonbones_BaseObject_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
void register_all_cocos2dx_dragonbones(JSContext* cx, JS::HandleObject obj);
bool js_cocos2dx_dragonbones_Matrix_Matrix(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_Transform_Transform(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *jsb_dragonBones_TextureData_class;
extern JSObject *jsb_dragonBones_TextureData_prototype;

bool js_cocos2dx_dragonbones_TextureData_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_TextureAtlasData_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_EventObject_EventObject(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_TransformObject_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_Slot_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_CCTextureData_CCTextureData(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_CCTextureAtlasData_CCTextureAtlasData(JSContext *cx, uint32_t argc, jsval *vp);

extern JSClass  *jsb_dragonBones_CCArmatureDisplay_class;
extern JSObject *jsb_dragonBones_CCArmatureDisplay_prototype;

bool js_cocos2dx_dragonbones_CCArmatureDisplay_constructor(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_CCSlot_CCSlot(JSContext *cx, uint32_t argc, jsval *vp);
...
bool js_cocos2dx_dragonbones_CCFactory_CCFactory(JSContext *cx, uint32_t argc, jsval *vp);
