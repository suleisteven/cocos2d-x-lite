...
protected:
    ...
    virtual void onHandlePropTypeBlendFunc(cocos2d::Node * pNode, cocos2d::Node * pParent, const char * pPropertyName, const cocos2d::BlendFunc& pCCBBlendFunc, CCBReader * ccbReader);
